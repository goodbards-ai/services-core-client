...
describe('resource products', () => {
  test('update', async () => {
    const responsePromise = clun.tenant.products.update(
  ...
  test('remove', async () => {
    const responsePromise = clun.tenant.products.remove(
      '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
      '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
    );
    const rawResponse = await responsePromise.asResponse();
