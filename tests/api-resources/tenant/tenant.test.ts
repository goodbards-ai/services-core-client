...
describe('resource tenant', () => {
  test('rename', async () => {
    const responsePromise = clun.tenant.rename('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e');
  ...
  test('rename: request options instead of params are passed correctly', async () => {
    ...
    await expect(
      clun.tenant.rename('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { path: '/_stainless_unknown_path' }),
